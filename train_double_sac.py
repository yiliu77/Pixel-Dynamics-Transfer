...
from models.double_sac import DoubleSAC
...
model = DoubleSAC(policy_config, value_config, embedding_config, s_config, sa_config, sas_config, source_env,
                    target_env, log_dir="darc_custom_rew_cheetah", ent_adj=True, n_updates_per_train=2, warmup_games=10)
# model.load_model("Cheetah-DARC-Custom-Rew-No-SA-300")
