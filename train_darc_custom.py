...
from models.darc_custom import DARCCustom
...
model = DARCCustom(policy_config, value_config, embedding_config, s_config, sa_config, sas_config, source_env,
                   target_env, log_dir="darc_custom_cheetah", ent_adj=True, n_updates_per_train=2, warmup_games=10)
...
model.save_model("Cheetah-DARC-Custom-400")
